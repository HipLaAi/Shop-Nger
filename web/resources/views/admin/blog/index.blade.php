            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                          <a class="btn btn-add btn-sm" href="admin/blog/create" title="Thêm"><i class="fas fa-plus"></i>
                            Tạo mới blog</a>
                        </div>
                        <!-- <div class="col-sm-2">
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center">Title blog</th>
                                ...
                                <td style="text-align: center">
                                    <form action="admin/blog/{{ $item->id }}" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP"
                                            onclick="window.location.href='{{ url('admin/blog/'.$item->id.'/edit') }}'"><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa blog này không?')"><i class="fas fa-trash-alt"></i> 
                                        </button>
                                    </form>
                                </td>
                            </tr>   
