...
<main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="">Sửa blog</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <h3 class="tile-title">Sửa blog</h3>
          <div class="tile-body">
            <form action="{{ route('blog.update', $blog->id) }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group col-md-12">
              <label for="exampleSelect1" class="control-label">Tên blog</label>
                <input name="name" class="form-control" type="text" value="{{ $blog->title }}">
              </div>
              <div class="form-group col-md-12" >
                ...
                <div class="list-images" style="display:flex;flex-wrap: wrap">
                  <div class="box-image" style="position: relative; margin:6px">
                    <img style="width: 285px;" src="images/{{ $blog->image }}" class="picture-box">
          ...
          <a class="btn btn-cancel" href="admin/blog">Hủy bỏ</a>
    </div>
</main>
@endsection
