            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                          <a class="btn btn-add btn-sm" href="admin/user/create" title="Thêm"><i class="fas fa-plus"></i>
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                            @foreach($user as $item)
                                <tr>
                                <td style="text-align: center"><img src="../images/{{$item->avatar}}" alt="" width="100px;"></td>
                                ...
                                <td style="text-align: center">
                                    <form action="admin/user/{{ $item->id }}" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP"
                                            onclick="window.location.href='{{ url('admin/user/'.$item->id.'/edit') }}'"><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa người dùng này không?')"><i class="fas fa-trash-alt"></i> 
                                        </button>
                                    </form>
                                </td>
                            </tr>   
