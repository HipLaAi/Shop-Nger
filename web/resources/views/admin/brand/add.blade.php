...
<main class="app-content">
    <div class="app-title">
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a>Thêm thương hiệu</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            <form action="{{route('brand.store')}}" method="POST" class="row"
            enctype="multipart/form-data">
              ...
              <div class="form-group col-md-12">
                <label class="control-label" for="description">Mô tả thương hiệu</label>
                <textarea name="description" class="form-control" id="description"></textarea>
              </div>
          </div>
          <button class="btn btn-save" type="submit">Lưu lại</button>
          <a class="btn btn-cancel" href="admin/brand">Hủy bỏ</a>
        </form>
    </div>
</main>
@endsection
