    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <div class="tile-body">
            <form action="{{ route('brand.update', $brand->id) }}" method="POST" class="row" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              ...
              <div class="form-group col-md-12" >
                ...
                <div class="list-images" style="display:flex;flex-wrap: wrap">
                  <div class="box-image" style="position: relative; margin:6px">
                    <img style="width: 285px;" src="images/{{ $brand->image }}" class="picture-box">
