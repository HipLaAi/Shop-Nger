...
<main class="app-content">
    <div class="app-title">
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item active"><a href="#"><b>Danh sách slide</b></a></li>
        </ul>
        <div id="clock"></div>
    </div>
    <div class="row">
            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="row element-button">
                        <div class="col-sm-2">
                          <a class="btn btn-add btn-sm" href="admin/slide/create" title="Thêm"><i class="fas fa-plus"></i>
                            Tạo mới slide</a>
                        </div>
                        <!-- <div class="col-sm-2">
                                ...
                                <td style="text-align: center">
                                    <form action="admin/slide/{{ $item->id }}" method="POST">
                                        ...
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal" data-target="#ModalUP"
                                            onclick="window.location.href='{{ url('admin/slide/'.$item->id.'/edit') }}'"><i class="fas fa-edit"></i></button>
                                        <button class="btn btn-primary btn-sm trash" type="submit" title="Xóa"
                                            onclick="return confirm('Bạn có chắc chắn muốn xóa slide này không?')"><i class="fas fa-trash-alt"></i> 
                                        </button>
                                    </form>
                                </td>
                            </tr>   
